    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-text-primary">Advance Metadata Controls</h2>
        </div>
        <button 
        ...
        <>
          ...
          {tab === 'metadata' ? (
            <div className="grid grid-cols-1 gap-4">
              ...
              {/* File Type Attributes Toggles */}
              <div className="space-y-3">
                <div className="label text-text-secondary mb-3">FILE TYPE ATTRIBUTES</div>
                <p className="text-xs text-text-tertiary mb-3">
                  Specify file attributes to ensure accurate title generation. These will be automatically appended to titles.
                </p>
              ...
              {value.platform === 'adobe' && (
                <div className="mt-4 p-3 bg-dark-surface/30 rounded-lg border border-green-accent/20">
                  <div className="text-xs font-bold text-text-secondary mb-2">Adobe Stock Guidelines</div>
                  <div className="text-xs text-text-tertiary leading-relaxed space-y-2">
                    <div>
                      <strong className="text-text-secondary font-bold">Title Guidelines:</strong>
                    ...
                    <div>
                      <strong className="text-text-secondary font-bold">Keyword Guidelines:</strong>
                      <ul className="list-disc list-inside ml-2 mt-1 space-y-0.5">
                    ...
                    <div className="mt-2 text-xs italic text-green-bright font-semibold">
            ...
            <div className="space-y-2">
              ...
              <div className="p-3 rounded border border-green-accent/20 text-sm bg-green-accent/10 font-medium">{promptPreview}</div>
            </div>
          )}
        </>
      )}
